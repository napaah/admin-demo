  ...
  <div class="page-container">
    ...
    <div class="toolbar" style="float:left;padding-top:10px;padding-left:15px;">
      <el-form :inline="true" :model="filters" :size="size">
        ...
        <el-form-item>
          <kt-button :label="$t('action.search')" icon="fa fa-search" perms="sys:dict:view" type="primary" @click="findPage(null)"/>
        </el-form-item>
        <el-form-item>
          <kt-button :label="$t('action.add')" icon="fa fa-plus" perms="sys:dict:add" type="primary" @click="handleAdd" />
        </el-form-item>
      </el-form>
    </div>
    <!--表格内容栏-->
    ...
    <!--新增编辑界面-->
    <el-dialog :title="operation?'新增':'编辑'" :visible.sync="editDialogVisible" :close-on-click-modal="false" width="40%">
