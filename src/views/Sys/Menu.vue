  ...
  <div class="page-container">
    ...
    <div class="toolbar" style="float:left;padding-top:10px;padding-left:15px;">
      <el-form :inline="true" :model="filters" :size="size">
        ...
        <el-form-item>
          <kt-button :label="$t('action.search')" icon="fa fa-search" perms="sys:menu:view" type="primary" @click="findTreeData(null)"/>
        </el-form-item>
        <el-form-item>
          <kt-button :label="$t('action.add')" icon="fa fa-plus" perms="sys:menu:add" type="primary" @click="handleAdd"/>
        </el-form-item>
      </el-form>
    </div>
    <!--表格树内容栏-->
    <el-table
      ...
      <el-table-column
        ...
        width="185">
        <template slot-scope="scope">
          <kt-button :label="$t('action.edit')" icon="fa fa-edit" perms="sys:menu:edit" @click="handleEdit(scope.row)"/>
          <kt-button :label="$t('action.delete')" icon="fa fa-trash" perms="sys:menu:delete" type="danger" @click="handleDelete(scope.row)"/>
        </template>
      </el-table-column>
    </el-table>
    <!-- 新增修改界面 -->
    <el-dialog :title="!dataForm.id ? '新增' : '修改'" :visible.sync="dialogVisible" :close-on-click-modal="false" width="40%">
      <el-form
        ref="dataForm"
        :model="dataForm"
        :rules="dataRule"
        ...
        <el-form-item v-if="dataForm.type !== 2" label="菜单图标" prop="icon">
          <el-row>
            <el-col :span="22">
              ...
              <el-input v-popover:iconListPopover v-model="dataForm.icon" :readonly="false" placeholder="菜单图标名称（如：fa fa-home fa-lg）" class="icon-list__input"/>
            </el-col>
            <el-col :span="2" class="icon-list__tips">
              <fa-icon-tooltip />
            </el-col>
